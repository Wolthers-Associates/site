document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            privacySubtitle: 'Data Protection and Privacy Information',
            privacyLastUpdated: 'Last updated: December 2024',
            privacyIntroTitle: 'Introduction',
            privacyIntroText1: 'Wolthers & Associates is committed to protecting your personal data and respecting your privacy. This Privacy Policy explains how we collect, use, store, and protect your personal information in accordance with applicable data protection laws, including Colombia\'s Law 1581 of 2012 (Habeas Data Law), Brazil\'s LGPD, and other applicable regulations.',
            privacyIntroText2: 'This policy applies to all personal data collected through our website, offices, and business operations in Santos (Brazil), Buenaventura (Colombia), and Guatemala City (Guatemala).',
            privacyControllerTitle: 'Data Controller',
            privacyControllerText: 'The entity responsible for the processing of your personal data is:',
            privacyHeadquarters: 'Headquarters:',
            privacyColombiaOffice: 'Colombia Office:',
            privacyGuatemalaOffice: 'Guatemala Office:',
            privacyContactEmail: 'Privacy Contact:',
            privacyDataCollectedTitle: 'Personal Data We Collect',
            privacyDataCollectedText: 'We may collect the following types of personal data:',
            privacyPurposesTitle: 'Purposes of Data Processing',
            privacyPurposesText: 'We process your personal data for the following purposes:',
            privacyLegalBasisTitle: 'Legal Basis for Processing',
            privacyLegalBasisText: 'We process your personal data based on one or more of the following legal grounds:',
            privacyVideoTitle: 'Video Surveillance Notice',
            privacyVideoSubtitle: 'CCTV and Security Cameras',
            privacyVideoText1: 'Our office facilities in Buenaventura (Colombia), Santos (Brazil), and Guatemala City are equipped with video surveillance systems (CCTV) for security purposes. This notice is provided in compliance with Colombian Law 1581 of 2012 and the guidelines issued by the Superintendencia de Industria y Comercio (SIC).',
            privacyVideoResponsible: 'Responsible Party:',
            privacyVideoResponsibleText: 'Wolthers & Associates Colombia - Buenaventura Office',
            privacyVideoPurpose: 'Purpose of Video Surveillance:',
            privacyVideoRetention: 'Data Retention:',
            privacyVideoRetentionText: 'Video recordings are retained for a maximum of 30 days, unless required for legal proceedings or investigations.',
            privacyVideoAccess: 'Access to Recordings:',
            privacyVideoAccessText: 'Access to video recordings is strictly limited to authorized security personnel and management. Recordings may be shared with law enforcement authorities when legally required.',
            privacyRightsTitle: 'Your Rights (Habeas Data)',
            privacyRightsText: 'Under applicable data protection laws, including Colombia\'s Law 1581 of 2012, you have the following rights:',
            privacyRightsExercise: 'To exercise any of these rights, please contact us at:',
            privacyRightsPhone: 'Phone (Colombia):',
            privacyRightsAddress: 'Address:',
            privacySecurityTitle: 'Data Security',
            privacySecurityText: 'We implement appropriate technical and organizational measures to protect your personal data against unauthorized access, alteration, disclosure, or destruction. These measures include:',
            privacyCookiesTitle: 'Cookies and Website Tracking',
            privacyCookiesText1: 'Our website uses cookies to improve your browsing experience. Cookies are small text files stored on your device that help us understand how you use our website.',
            privacyCookiesText2: 'We use the following types of cookies:',
            privacyCookiesText3: 'You can manage your cookie preferences through your browser settings.',
            privacyTransfersTitle: 'International Data Transfers',
            privacyTransfersText: 'As an international company with offices in Brazil, Colombia, and Guatemala, your personal data may be transferred between our offices. We ensure that all transfers comply with applicable data protection laws and that appropriate safeguards are in place.',
            privacyContactTitle: 'Contact Us',
            privacyContactText: 'If you have any questions about this Privacy Policy or our data protection practices, please contact us:',
            privacyContactPrivacy: 'Privacy Inquiries',
            privacyContactGeneral: 'General Inquiries:',
            privacyAuthorityTitle: 'Supervisory Authority',
            privacyAuthorityText: 'In Colombia, the supervisory authority for data protection matters is:',
            privacyAuthorityAddress: 'Address: Carrera 13 No. 27-00, Bogotá, Colombia'
        },
        pt: {
            // Navigation
            navHome: 'Início',
            ...
            privacySubtitle: 'Proteção de Dados e Informações de Privacidade',
            privacyLastUpdated: 'Última atualização: Dezembro de 2024',
            privacyIntroTitle: 'Introdução',
            privacyIntroText1: 'A Wolthers & Associates está comprometida em proteger seus dados pessoais e respeitar sua privacidade. Esta Política de Privacidade explica como coletamos, usamos, armazenamos e protegemos suas informações pessoais de acordo com as leis de proteção de dados aplicáveis, incluindo a Lei 1581 de 2012 da Colômbia (Lei de Habeas Data), a LGPD do Brasil e outras regulamentações aplicáveis.',
            privacyIntroText2: 'Esta política se aplica a todos os dados pessoais coletados através do nosso site, escritórios e operações comerciais em Santos (Brasil), Buenaventura (Colômbia) e Cidade da Guatemala (Guatemala).',
            privacyControllerTitle: 'Controlador de Dados',
            privacyControllerText: 'A entidade responsável pelo tratamento dos seus dados pessoais é:',
            privacyHeadquarters: 'Sede:',
            privacyColombiaOffice: 'Escritório na Colômbia:',
            privacyGuatemalaOffice: 'Escritório na Guatemala:',
            privacyContactEmail: 'Contato de Privacidade:',
            privacyDataCollectedTitle: 'Dados Pessoais que Coletamos',
            privacyDataCollectedText: 'Podemos coletar os seguintes tipos de dados pessoais:',
            privacyPurposesTitle: 'Finalidades do Tratamento de Dados',
            privacyPurposesText: 'Tratamos seus dados pessoais para as seguintes finalidades:',
            privacyLegalBasisTitle: 'Base Legal para o Tratamento',
            privacyLegalBasisText: 'Tratamos seus dados pessoais com base em uma ou mais das seguintes bases legais:',
            privacyVideoTitle: 'Aviso de Videovigilância',
            privacyVideoSubtitle: 'CFTV e Câmeras de Segurança',
            privacyVideoText1: 'Nossas instalações em Buenaventura (Colômbia), Santos (Brasil) e Cidade da Guatemala estão equipadas com sistemas de videovigilância (CFTV) para fins de segurança. Este aviso é fornecido em conformidade com a Lei 1581 de 2012 da Colômbia e as diretrizes emitidas pela Superintendencia de Industria y Comercio (SIC).',
            privacyVideoResponsible: 'Parte Responsável:',
            privacyVideoResponsibleText: 'Wolthers & Associates Colômbia - Escritório de Buenaventura',
            privacyVideoPurpose: 'Finalidade da Videovigilância:',
            privacyVideoRetention: 'Retenção de Dados:',
            privacyVideoRetentionText: 'As gravações de vídeo são retidas por no máximo 30 dias, salvo se necessário para procedimentos legais ou investigações.',
            privacyVideoAccess: 'Acesso às Gravações:',
            privacyVideoAccessText: 'O acesso às gravações de vídeo é estritamente limitado ao pessoal de segurança autorizado e à gerência. As gravações podem ser compartilhadas com autoridades policiais quando legalmente exigido.',
            privacyRightsTitle: 'Seus Direitos (Habeas Data)',
            privacyRightsText: 'De acordo com as leis de proteção de dados aplicáveis, incluindo a Lei 1581 de 2012 da Colômbia, você tem os seguintes direitos:',
            privacyRightsExercise: 'Para exercer qualquer um desses direitos, entre em contato conosco:',
            privacyRightsPhone: 'Telefone (Colômbia):',
            privacyRightsAddress: 'Endereço:',
            privacySecurityTitle: 'Segurança de Dados',
            privacySecurityText: 'Implementamos medidas técnicas e organizacionais apropriadas para proteger seus dados pessoais contra acesso não autorizado, alteração, divulgação ou destruição. Essas medidas incluem:',
            privacyCookiesTitle: 'Cookies e Rastreamento do Site',
            privacyCookiesText1: 'Nosso site usa cookies para melhorar sua experiência de navegação. Cookies são pequenos arquivos de texto armazenados em seu dispositivo que nos ajudam a entender como você usa nosso site.',
            privacyCookiesText2: 'Usamos os seguintes tipos de cookies:',
            privacyCookiesText3: 'Você pode gerenciar suas preferências de cookies através das configurações do seu navegador.',
            privacyTransfersTitle: 'Transferências Internacionais de Dados',
            privacyTransfersText: 'Como uma empresa internacional com escritórios no Brasil, Colômbia e Guatemala, seus dados pessoais podem ser transferidos entre nossos escritórios. Garantimos que todas as transferências estejam em conformidade com as leis de proteção de dados aplicáveis e que salvaguardas apropriadas estejam em vigor.',
            privacyContactTitle: 'Entre em Contato',
            privacyContactText: 'Se você tiver alguma dúvida sobre esta Política de Privacidade ou nossas práticas de proteção de dados, entre em contato:',
            privacyContactPrivacy: 'Consultas de Privacidade',
            privacyContactGeneral: 'Consultas Gerais:',
            privacyAuthorityTitle: 'Autoridade Supervisora',
            privacyAuthorityText: 'Na Colômbia, a autoridade supervisora para questões de proteção de dados é:',
            privacyAuthorityAddress: 'Endereço: Carrera 13 No. 27-00, Bogotá, Colômbia'
        },
        es: {
            // Navigation
            navHome: 'Inicio',
            ...
            privacySubtitle: 'Protección de Datos e Información de Privacidad',
            privacyLastUpdated: 'Última actualización: Diciembre de 2024',
            privacyIntroTitle: 'Introducción',
            privacyIntroText1: 'Wolthers & Associates está comprometida con la protección de sus datos personales y el respeto a su privacidad. Esta Política de Privacidad explica cómo recopilamos, usamos, almacenamos y protegemos su información personal de acuerdo con las leyes de protección de datos aplicables, incluyendo la Ley 1581 de 2012 de Colombia (Ley de Habeas Data), la LGPD de Brasil y otras regulaciones aplicables.',
            privacyIntroText2: 'Esta política se aplica a todos los datos personales recopilados a través de nuestro sitio web, oficinas y operaciones comerciales en Santos (Brasil), Buenaventura (Colombia) y Ciudad de Guatemala (Guatemala).',
            privacyControllerTitle: 'Responsable del Tratamiento',
            privacyControllerText: 'La entidad responsable del tratamiento de sus datos personales es:',
            privacyHeadquarters: 'Sede Principal:',
            privacyColombiaOffice: 'Oficina en Colombia:',
            privacyGuatemalaOffice: 'Oficina en Guatemala:',
            privacyContactEmail: 'Contacto de Privacidad:',
            privacyDataCollectedTitle: 'Datos Personales que Recopilamos',
            privacyDataCollectedText: 'Podemos recopilar los siguientes tipos de datos personales:',
            privacyPurposesTitle: 'Finalidades del Tratamiento de Datos',
            privacyPurposesText: 'Tratamos sus datos personales para las siguientes finalidades:',
            privacyLegalBasisTitle: 'Base Legal para el Tratamiento',
            privacyLegalBasisText: 'Tratamos sus datos personales con base en uno o más de los siguientes fundamentos legales:',
            privacyVideoTitle: 'Aviso de Videovigilancia',
            privacyVideoSubtitle: 'CCTV y Cámaras de Seguridad',
            privacyVideoText1: 'Nuestras instalaciones en Buenaventura (Colombia), Santos (Brasil) y Ciudad de Guatemala están equipadas con sistemas de videovigilancia (CCTV) con fines de seguridad. Este aviso se proporciona en cumplimiento de la Ley 1581 de 2012 de Colombia y los lineamientos emitidos por la Superintendencia de Industria y Comercio (SIC).',
            privacyVideoResponsible: 'Responsable:',
            privacyVideoResponsibleText: 'Wolthers & Associates Colombia - Oficina de Buenaventura',
            privacyVideoPurpose: 'Finalidad de la Videovigilancia:',
            privacyVideoRetention: 'Retención de Datos:',
            privacyVideoRetentionText: 'Las grabaciones de video se conservan por un máximo de 30 días, salvo que sean requeridas para procedimientos legales o investigaciones.',
            privacyVideoAccess: 'Acceso a las Grabaciones:',
            privacyVideoAccessText: 'El acceso a las grabaciones de video está estrictamente limitado al personal de seguridad autorizado y a la gerencia. Las grabaciones pueden compartirse con las autoridades policiales cuando sea legalmente requerido.',
            privacyRightsTitle: 'Sus Derechos (Habeas Data)',
            privacyRightsText: 'De acuerdo con las leyes de protección de datos aplicables, incluyendo la Ley 1581 de 2012 de Colombia, usted tiene los siguientes derechos:',
            privacyRightsExercise: 'Para ejercer cualquiera de estos derechos, contáctenos:',
            privacyRightsPhone: 'Teléfono (Colombia):',
            privacyRightsAddress: 'Dirección:',
            privacySecurityTitle: 'Seguridad de Datos',
            privacySecurityText: 'Implementamos medidas técnicas y organizativas apropiadas para proteger sus datos personales contra acceso no autorizado, alteración, divulgación o destrucción. Estas medidas incluyen:',
            privacyCookiesTitle: 'Cookies y Seguimiento del Sitio Web',
            privacyCookiesText1: 'Nuestro sitio web utiliza cookies para mejorar su experiencia de navegación. Las cookies son pequeños archivos de texto almacenados en su dispositivo que nos ayudan a entender cómo utiliza nuestro sitio web.',
            privacyCookiesText2: 'Utilizamos los siguientes tipos de cookies:',
            privacyCookiesText3: 'Puede gestionar sus preferencias de cookies a través de la configuración de su navegador.',
            privacyTransfersTitle: 'Transferencias Internacionales de Datos',
            privacyTransfersText: 'Como empresa internacional con oficinas en Brasil, Colombia y Guatemala, sus datos personales pueden transferirse entre nuestras oficinas. Garantizamos que todas las transferencias cumplan con las leyes de protección de datos aplicables y que existan las salvaguardas apropiadas.',
            privacyContactTitle: 'Contáctenos',
            privacyContactText: 'Si tiene alguna pregunta sobre esta Política de Privacidad o nuestras prácticas de protección de datos, contáctenos:',
            privacyContactPrivacy: 'Consultas de Privacidad',
            privacyContactGeneral: 'Consultas Generales:',
            privacyAuthorityTitle: 'Autoridad de Supervisión',
            privacyAuthorityText: 'En Colombia, la autoridad de supervisión para asuntos de protección de datos es:',
            privacyAuthorityAddress: 'Dirección: Carrera 13 No. 27-00, Bogotá, Colombia'
        }
    };
